...
echo 'a0b8d848-7c12-47fd-955f-c61c40d858af:{"board":{"pieces":{"0,0":"BLACK"},"size":19},"captures":{"black":0,"white":0},"turn":2,"playerUp":"WHITE"}' | kafkacat -b kafka:9092 -t bugout-game-states  -K: -P
sleep 5
