...
// replies & events
data class WaitForOpponent(val gameId: GameId, val replyTo: ReqId, val eventId: EventId, val epochMillis: Long)
data class GameReady(val gameId: GameId, val eventId: EventId, val epochMillis: Long)
